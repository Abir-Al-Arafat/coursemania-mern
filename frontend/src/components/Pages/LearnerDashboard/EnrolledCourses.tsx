...
const EnrolledCourses: React.FC = () => {
  ...
  const handleUnsubscribe = (course: Course) => {
    setSelectedCourse(course);
    setShowModal(true);
  };

  const handleConfirmUnsubscribe = (confirmed: boolean) => {
          ...
          <div className="p-4">
            ...
            <div className="flex justify-between items-center mt-4">
              <button
                ...
                onClick={() => handleUnsubscribe(course)}
              >
                Unsubscribe
              </button>
              <button
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-8 rounded-md shadow-md">
            <p>
              Are you sure you want to unsubscribe from {selectedCourse?.title}?
            </p>
