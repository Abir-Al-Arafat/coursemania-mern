...
const PendingSubscriptions: React.FC = () => {
  ...
  const handleRemoveRequest = (course: Course) => {
    setSelectedCourse(course);
    setShowModal(true);
  };

  const handleConfirmRemoveRequest = (confirmed: boolean) => {
          ...
          <div className="p-4">
            ...
            <div className="flex justify-between items-center mt-4">
              <button
                ...
                onClick={() => handleRemoveRequest(course)}
              >
                Remove Request
              </button>
              <button
          ...
          <div className="bg-white p-8 rounded-md shadow-md">
            ...
            <div className="mt-4 flex justify-end">
              <button
                ...
                onClick={() => handleConfirmRemoveRequest(true)}
              >
                Yes
              </button>
              <button
                className="bg-gray-300 text-gray-800 px-4 py-2 rounded-md"
                onClick={() => handleConfirmRemoveRequest(false)}
              >
                No
              </button>
            </div>
